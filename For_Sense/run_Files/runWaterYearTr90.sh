#!/bin/bash
#SBATCH --job-name=WaterYearTr90 
#SBATCH --output=/cxfs/projects/usgs/ecosystems/sbsc/drylandeco/AFRI/Exposure_Data/WaterYearTr90.out 
#SBATCH -n 1
#SBATCH -c 20
#SBATCH -p normal
