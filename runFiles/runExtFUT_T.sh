#!/bin/bash
#SBATCH --job-name=ExtFUT_T                      # the name of your job
#SBATCH --output=/home/jbb239/ExtFUT_T.out	# this is the file your output and errors go to
