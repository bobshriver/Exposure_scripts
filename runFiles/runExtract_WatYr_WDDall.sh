#!/bin/bash
#SBATCH --job-name=ExtractWY_WDDall                      # the name of your job
#SBATCH --output=/home/jbb239/Extract_WY_WDDall.out	# this is the file your output and errors go to
...
srun date
srun Rscript Extract_WatYr_WDDalllyrs.R
srun date
