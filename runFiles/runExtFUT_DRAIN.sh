#!/bin/bash
#SBATCH --job-name=ExFDRAIN                      # the name of your job
#SBATCH --output=/home/jbb239/ExFDRAIN.out	# this is the file your output and errors go to
