#!/bin/bash
#SBATCH --job-name=ExFUT_SWAallJM                      # the name of your job
#SBATCH --output=/home/jbb239/ExFUT_SWAallJM.out	# this is the file your output and errors go to
...
srun date
srun Rscript ExtFUT_SWAall_JanMar.R
srun date
