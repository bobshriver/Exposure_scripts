#!/bin/bash
#SBATCH --job-name=ExtFUT_WDDall                      # the name of your job
#SBATCH --output=/home/jbb239/ExtFUT_WDDall.out	# this is the file your output and errors go to
