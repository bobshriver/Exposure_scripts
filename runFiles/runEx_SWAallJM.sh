#!/bin/bash
#SBATCH --job-name=ExFSWAallJM                      # the name of your job
#SBATCH --output=/home/jbb239/ExFSWAallJM.out	# this is the file your output and errors go to
...
srun date
srun Rscript Ex_SWABall_JanMar.R
srun date
