#!/bin/bash
#SBATCH --job-name=ExtFUT_transp                      # the name of your job
#SBATCH --output=/home/jbb239/ExtFUT_transp.out	# this is the file your output and errors go to
