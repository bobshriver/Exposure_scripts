#!/bin/bash
#SBATCH --job-name=Extract_WY_Tr                      # the name of your job
#SBATCH --output=/home/jbb239/Extract_WY_Tr.out	# this is the file your output and errors go to
...
srun date
srun Rscript Extract_WatYr_Tr.R
srun date
