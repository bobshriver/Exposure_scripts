#!/bin/bash
#SBATCH --job-name=ExFUT_SWAallJS                      # the name of your job
#SBATCH --output=/home/jbb239/ExFUT_SWAallJS.out	# this is the file your output and errors go to
...
srun date
srun Rscript ExtFUT_SWAall_JulSep.R
srun date
