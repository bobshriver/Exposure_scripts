#!/bin/bash
#SBATCH --job-name=Extract_PET                      # the name of your job
#SBATCH --output=/home/jbb239/Extract_PET.out	# this is the file your output and errors go to
