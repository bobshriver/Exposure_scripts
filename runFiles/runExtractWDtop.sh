#!/bin/bash
#SBATCH --job-name=ExtractWDtop                      # the name of your job
#SBATCH --output=/home/jbb239/ExtractWDtop.out	# this is the file your output and errors go to
