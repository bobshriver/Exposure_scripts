#!/bin/bash
#SBATCH --job-name=Extract_WY_WDtop                      # the name of your job
#SBATCH --output=/home/jbb239/Extract_WY_WDtop.out	# this is the file your output and errors go to
...
srun date
srun Rscript Extract_WatYr_WDtop.R
srun date
