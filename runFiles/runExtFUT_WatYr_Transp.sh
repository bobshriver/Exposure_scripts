#!/bin/bash
#SBATCH --job-name=ExtFUT_WatYr_transp                      # the name of your job
#SBATCH --output=/home/jbb239/ExtFUT_WatYr_transp.out	# this is the file your output and errors go to
...
srun date
srun Rscript ExtFUT_WatYr_Trans.R
srun date
