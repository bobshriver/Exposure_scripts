#!/bin/bash
#SBATCH --job-name=Extract_WYT                      # the name of your job
#SBATCH --output=/home/jbb239/Extract_WYT.out	# this is the file your output and errors go to
...
srun date
srun Rscript Extract_WatYr_T.R
srun date
