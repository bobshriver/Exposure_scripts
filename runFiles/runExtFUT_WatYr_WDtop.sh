#!/bin/bash
#SBATCH --job-name=ExtFUT_WatYr_WDtop                      # the name of your job
#SBATCH --output=/home/jbb239/ExtFUT_WatYr_WDtop.out	# this is the file your output and errors go to
...
srun date
srun Rscript ExtFUT_WatYr_WDtop.R
srun date
