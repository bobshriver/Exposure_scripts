#!/bin/bash
#SBATCH --job-name=ExtFUT_WDtop                      # the name of your job
#SBATCH --output=/home/jbb239/ExtFUT_WDtop.out	# this is the file your output and errors go to
