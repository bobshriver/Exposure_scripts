#!/bin/bash
#SBATCH --job-name=ExtractTr                      # the name of your job
#SBATCH --output=/home/jbb239/ExtractTr.out	# this is the file your output and errors go to
