#!/bin/bash
#SBATCH --job-name=Extract_AETtoPET                      # the name of your job
#SBATCH --output=/home/jbb239/Extract_AETtoPET.out	# this is the file your output and errors go to
...
srun date
srun Rscript ExtractAETtoPET.R
srun date
