...
#print(str(annPET))
  ...
  ifelse (r == 1, annualPET <- annPET, annualPET <- rbind(annualPET, annPET))
  #print(str(annualPET))
  names(annPET) <- paste(c(1915:2015))
}

names(annualPET) <- paste(c(1915:2015))
save(annualPET, file=file.path(dir.jbHOME, "annualPET19152015"))
